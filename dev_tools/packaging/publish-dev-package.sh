...
# Prod installation:
#
#     pip install openfermioncirq==VERSION_YOU_UPLOADED
#
# Python 3 test installation:
#
#     pip install -r requirements.txt
#     pip install --index-url https://test.pypi.org/simple/ openfermioncirq==VERSION_YOU_UPLOADED
#
