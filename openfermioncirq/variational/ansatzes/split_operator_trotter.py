...
class SplitOperatorTrotterAnsatz(VariationalAnsatz):
    ...
    # pylint: disable=line-too-long
        ...
        0             1                    2                    3
        │             │                    │                    │
        │             │                    PhISwap(0.25)────────PhISwap(0.25)^0.5
        │             │                    │                    │
        │             PhISwap(0.25)────────PhISwap(0.25)^0.608  │
        │             │                    │                    │
        │             │                    PhISwap(0.25)────────PhISwap(0.25)^(-1/3)
        │             │                    │                    │
        PhISwap(0.25)─PhISwap(0.25)^(2/3)  │                    │
        │             │                    │                    │
        Rz(-π)        PhISwap(0.25)────────PhISwap(0.25)        │
        │             │                    │                    │
        Rz(π)         Rz(-π)               PhISwap(0.25)────────PhISwap(0.25)^-0.392
        │             │                    │                    │
        │             Z^U_1_0              │                    Rz(-π)
        │             │                    │                    │
        ...
        │             │                    │                    Rz(π)
        │             │                    │                    │
        │             │                    PhISwap(0.25)────────PhISwap(0.25)^0.392
        │             │                    │                    │
        ...
        │             │                    PhISwap(0.25)────────PhISwap(0.25)^(2/3)
        │             │                    │                    │
        │             PhISwap(0.25)────────PhISwap(0.25)        Rz(-π)
        │             │                    │                    │
        PhISwap(0.25)─PhISwap(0.25)^-0.392 Rz(-π)               Rz(π)
        │             │                    │                    │
        Rz(-π)        │                    Z^U_1_0              │
        │             │                    │                    │
